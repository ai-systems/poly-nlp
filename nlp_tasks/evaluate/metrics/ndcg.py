...
from .metric import Metric, MODEL_NAME, SPLIT_NAME, METRIC_LABEL, SCORE
import numpy as np
...
class NDCG(Metric):
    ...
    def calc_metric(self):
        ...
        return np.mean(
            [self.average_precision(a, predicted[id]) for id, a in self.actual.items()]
        )
